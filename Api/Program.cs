...
ErrosDeValidacao validaDTO(VeiculoDTO veiculoDTO)
{
    ...
    if (string.IsNullOrEmpty(veiculoDTO.Nome))
        validacao.Mensagens.Add("O nome do veiculo pode está vazio.");
    if (string.IsNullOrEmpty(veiculoDTO.Marca))
        validacao.Mensagens.Add("A marca do veiculo pode está vazia.");
    if (veiculoDTO.Ano < 1940)
        validacao.Mensagens.Add("O ano do veiculo deve ser maior que 1940.");
